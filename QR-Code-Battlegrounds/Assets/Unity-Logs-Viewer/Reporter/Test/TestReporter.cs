...
public class TestReporter : MonoBehaviour
{
	...
	void Start()
	{
		...
		rect1 = new Rect(Screen.width / 2 - 440, Screen.height / 2 - 850, 880, 50);
		rect2 = new Rect(Screen.width / 2 - 440, Screen.height / 2 - 800, 880, 100);
		...
		rect6 = new Rect(Screen.width / 2 - 440, Screen.height / 2 - 800, 880, 50);
